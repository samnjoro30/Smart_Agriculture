...
export default function Sidebar() {
  ...
  return (
      // <div className="fixed md:static top-0 left-0 h-screen md:h-auto w-70 bg-green-100 shadow-md p-4 space-y-6 mx-5 transform transition-transform duration-300 ">
        <div className="sticky top-0 left-1 md:h-auto overflow-y-auto shrink-0 w-16 md:w-64 bg-green-200 shadow-md p-2 md:p-4 space-y-6 transition-all duration-300 ">
        <div>
