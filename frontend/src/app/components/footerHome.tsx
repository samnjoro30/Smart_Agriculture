            ...
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                       ...
                       <li className="hover:underline"><Link href="/auth/register" prefetch={true} >Register</Link></li>
                       <li className="hover:underline"><Link href="/auth/login" prefetch={true} >Login</Link></li>
