            ...
            {animal.category === 'cow' ? (
              <>
                ...
                <span className="text-right">
                  <span
                    className={`px-2 py-1 rounded-md font-bold text-[10px] uppercase tracking-wider ${animal.heatStatus ? 'bg-orange-100 text-orange-700 border border-orange-200' : 'bg-gray-100 text-gray-500'}`}
                  >
                ...
                <span className="text-right">
                  <span
                    className={`px-2 py-1 rounded-md font-bold text-[10px] uppercase tracking-wider ${animal.pregnant ? 'bg-purple-100 text-purple-700 border border-purple-200' : 'bg-blue-50 text-blue-600'}`}
                  >
