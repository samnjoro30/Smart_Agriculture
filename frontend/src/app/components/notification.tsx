      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-green-200 shadow-md rounded-xl p-4 border border-green-100">
            <h3 className="text-green-600 font-bold text-lg mb-3">Weekly</h3>
            ...
            <div className="space-y-3">
              {weekly.map((note) => (
                ...
                >
                  <h4 className="font-semibold text-green-700">{note.title}</h4>
          ...
          <div className="bg-green-200 shadow-md rounded-xl p-4 border border-blue-100">
            <h3 className="text-green-600 font-bold text-lg mb-3">Monthly</h3>
            ...
            <div className="space-y-3">
              {monthly.map((note) => (
                ...
                >
                  <h4 className="font-semibold text-blue-700">{note.title}</h4>
                  <p className="text-gray-700">{note.message}</p>
                  <p className="text-xs text-gray-500 mt-1">
                    {new Date(note.createdAt).toLocaleDateString()}
                  </p>
