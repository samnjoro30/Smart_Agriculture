      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav>
            <ul className="hidden md:flex space-x-6 text-green-800 font-medium">
                ...
                <li><Link href="/auth/login" className="bg-green-600 text-white px-4 py-1.5 rounded-full hover:bg-green-700 transition-all duration-200">Login</Link></li>
                <li> <Link href="/auth/register" className="bg-green-600 text-white px-4 py-1.5 rounded-full hover:bg-green-700 transition-all duration-200" > Register </Link> </li>
