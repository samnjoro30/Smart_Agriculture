...
export default function Homepage() {
  ...
  const Description =
    'This is a platform designed to help farmers track and improve productiivity in there farms by simple clicks where you enjoy seamless advantages of AI, ML prediction and timely production';
      ...
      <main>
        <section className="relative h-[50vh] w-full mt-1 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 text-center backdrop-blur-sm bg-white/10 rounded-xl">
            ...
            <p className="max-w-3xl text-base md:text-lg font-medium leading-relaxed text-green-100 mb-2 drop-shadow">
              {Description}
            </p>
            <p className="text-green-200 font-semibold text-lg md:text-xl animate-pulse">
              🌱 Make Chaguo Smart for your Farm —{' '}
              <Link href="/auth/register">Register with us!</Link>
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-4 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
              <p className={pFarmersSay}>
                &quot;Since I started using Smart Farm, managing my crops and
                livestock has become easier and more productive. The AI insights
                have helped me plan better.&quot;
              </p>
              <p className={pFarmerName}>
                - Nancy .W., Smallholder Farmer in Muranga
              </p>
            </div>
            <div className="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
              <p className={pFarmersSay}>
                &quot;The platform's real-time analytics allowed me to identify
                water stress in my farm early. Smart Irrigation suggestions
                saved my entire season.&quot;
              </p>
              <p className={pFarmerName}>- John K., Farmer in Nyandarua</p>
            </div>
            <div className="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
              <p className={pFarmersSay}>
                &quot;Breeding tracking has never been this accurate. Now I have
                a predictable cycle for my dairy cows, and milk production has
                increased.&quot;
              </p>
