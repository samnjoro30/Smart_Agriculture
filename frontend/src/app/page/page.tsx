                ...
                <section className="py-12 px-4 bg-green-100 ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
                        ...
                        <div className={serviceDiv}>
                            <Image  src="/logo.png" alt="logo" width={100} height={40} className="mx-auto mb-4"/>
                            <h3 className="text-xl font-semibold text-green-800 mb-2">Farm Inventory</h3>
                            <p className="text-gray-700 text-sm">You get your record well architectured and simplified for you to understand. The inventory helps you to plan for the farm management </p>
                        ...
                        <div className={serviceDiv}>
                            ...
                            <p className={pservice}>We are helping farmers track there breeding enabling upto 99% correct prediction of breeding interval, type of breed</p>
                        </div>
                    </div>
                </section>
                <section>
